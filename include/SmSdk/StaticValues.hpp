...
{
public:
	using PaintToolPaintLimiterType = StaticVariable<int32_t, SM_VAR_PAINT_DRAG_LIMITER>;
	using PaintToolEraseLimiterType = StaticVariable<int32_t, SM_VAR_PAINT_ERASE_LIMITER>;
	using BlockBuildLimiterType = StaticVariable<int32_t, SM_VAR_BLOCK_BUILD_LIMITER>;
